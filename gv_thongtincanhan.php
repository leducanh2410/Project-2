    ...
    <div class="diem-container row">
        ...
        <div class="col-9 thongtin-container">
            <div class="row d-flex">
                <div class="col-8">
                    <div class="thongtin-content hovaten">Họ và tên: Nguyễn Văn Y</div>
                    <div class="thongtin-content ngaysinh">Ngày sinh: 1/1/2004</div>
                    <div class="thongtin-content nienkhoa">CMND: XXXXXXXXX</div>
                    <div class="thongtin-content lop">Email: gv@gmail.com</div>
                    <div class="thongtin-content sodienthoai">Số điện thoại: 012345****</div>
                </div>
                <div class="col-4">
                    <div class="avatar">
